...
export default function PortofolioClient({ initialStats }: { initialStats: { projects: number; journeys: number; achievements: number } }) {
  const [stats, setStats] = useState<Stats>(initialStats);
  const [loading, setLoading] = useState(false);

  const totalItems = stats.projects + stats.journeys + stats.achievements;
