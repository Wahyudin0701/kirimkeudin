...
export default function DashboardPencapaianPage() {
  ...
  const fetchItems = useCallback(async () => { setLoading(true); const res = await fetch("/api/achievements"); setItems(await res.json()); setLoading(false); }, []);
