...
export default function PerjalananClient({ initialItems }: { initialItems: Journey[] }) {
              ...
              <div className="flex-1 min-w-0 w-full">
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2 md:gap-3">
                  ...
                  <div className="flex items-center gap-1.5 md:gap-2 self-start sm:self-auto flex-shrink-0 bg-ku-bg sm:bg-transparent p-1.5 sm:p-0 rounded-lg">
                    ...
                    <button onClick={() => setItemToDelete(item.id)} disabled={deleting === item.id} className="p-1.5 md:p-2 rounded-lg text-text-muted hover:text-red-500 hover:bg-red-50">
          ...
          {itemToDelete && (
            <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/20 backdrop-blur-sm">
              ...
              >
                ...
                <h3 className="font-montserrat font-extrabold text-lg text-ku-navy mb-2">Hapus Perjalanan?</h3>
                <p className="font-jakarta text-sm text-text-muted mb-6">
                  Data perjalanan ini akan dihapus secara permanen dan tidak dapat dikembalikan.
                </p>
